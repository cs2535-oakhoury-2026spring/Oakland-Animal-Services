...
export function findSimilarNotes(searchNote, allNotes, options = {}) {
    console.log(`___Starting search for similar notes...\nSearch Note: "${searchNote}"\nTotal Notes: ${allNotes.length}\n`);
    ...
    console.log(`Extracted ${keywords.length} keywords in ${(endExtractTime - startExtractTime).toFixed(2)} ms\n`);
    ...
    console.log(`Preprocessed ${allNotes.length} notes in ${(endTime - startTime).toFixed(2)} ms\n`);
    ...
    console.log(`Found matches for ${keywords.length} keywords in ${(endFindTime - startFindTime).toFixed(2)} ms\n`);
    ...
    console.log(`Total search time: ${(endOverallTime - startOverallTime).toFixed(2)} ms\n`);
