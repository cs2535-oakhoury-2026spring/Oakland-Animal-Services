...
router.get("/api/pets/:petId/compatibility", authenticate, getCompatibilityHandler);
router.put("/api/pets/:petId/compatibility", authenticate, updateCompatibilityHandler);
