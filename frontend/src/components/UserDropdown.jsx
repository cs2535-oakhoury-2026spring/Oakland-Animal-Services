  ...
  return (
    <div ref={ref} className="ud-wrapper">
      ...
      >
        ...
        {!compact && <span className="ud-trigger-name">{user?.displayName || user?.username || "User"}</span>}
      ...
      {open && (
        <div role="menu" className="ud-menu">
          ...
          <div className="ud-section">
            ...
            {isAdmin && navItem("User Management", <Icons.users size={14} color="var(--clr-warm-gray)" />, "/?view=users", currentPath.includes("view=users"))}
          </div>
